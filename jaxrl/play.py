...
def load_policy(experiment: Experiment, env, max_steps, task_count, load: bool, rngs: nnx.Rngs) -> TransformerActorCritic:
...
def play_from_run(
    ...
    env, task_count = env_factory.create_env(config.environment, config.max_env_steps, 1, env_name)
