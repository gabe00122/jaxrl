...
class TransformerConfig:
    ...
    def from_params(cls, params: params_lib.Params) -> TransformerConfig:
        ...
        use_post_attn_norm = "post_attention_norm" in params["transformer"]["layer_0"]
        ...
        layer_names = [name for name in params["transformer"].keys() if "layer" in name]
    ...
    def __init__(
        ...
        *,
        ...
        self.layers = [
            ...
            for _, attn_type in zip(range(config.num_layers), config.attention_types)
        ]
