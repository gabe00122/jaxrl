...
class TransformerTest(parameterized.TestCase):
    ...
    def test_logit_softcap(
        ...
        config_soft_cap = transformer_lib.TransformerConfig(**(params | soft_cap_args))
        ...
        soft_cap_outputs, no_soft_cap_outputs = (
            all_outputs  # pylint: disable=unbalanced-tuple-unpacking
        )
    ...
    def test_forward_no_cache(
        ...
        attention_mask = jnp.ones((batch_size, seq_size, cache_size), dtype=jnp.bool)
